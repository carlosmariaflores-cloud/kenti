...
plt.rcParams.update({'font.family':'TeX Gyre Pagella','font.size':10,'axes.spines.top':False,'axes.spines.right':False,'axes.edgecolor':'#8a8f80','axes.labelcolor':'#18200f','xtick.color':'#555b4a','ytick.color':'#555b4a','axes.grid':False})
...
a.set_xscale('log'); a.set_xticks(Ns); a.set_xticklabels([str(n) for n in Ns],rotation=0,fontsize=9)
...
b.set_xscale('log'); b.set_xticks(Ns); b.set_xticklabels([str(n) for n in Ns],fontsize=9); b.minorticks_off()
b.set_xlabel('Tamaño de la muestra (N, individuos)'); b.set_ylabel('Valor relativo al obtenido con N = 5000')
b.set_ylim(0,1.3)
